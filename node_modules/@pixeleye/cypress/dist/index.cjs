...
// ../../node_modules/.pnpm/rrweb-snapshot@2.0.0-alpha.14/node_modules/rrweb-snapshot/lib/rrweb-snapshot.cjs
var require_rrweb_snapshot = __commonJS({
  "../../node_modules/.pnpm/rrweb-snapshot@2.0.0-alpha.14/node_modules/rrweb-snapshot/lib/rrweb-snapshot.cjs"(exports2) {
    "use strict";
    ...
    })(exports2.NodeType || (exports2.NodeType = {}));
    ...
    function isNodeMetaEqual(a, b) {
      if (!a || !b || a.type !== b.type)
        return false;
      if (a.type === exports2.NodeType.Document)
        return a.compatMode === b.compatMode;
      else if (a.type === exports2.NodeType.DocumentType)
        return a.name === b.name && a.publicId === b.publicId && a.systemId === b.systemId;
      else if (a.type === exports2.NodeType.Comment || a.type === exports2.NodeType.Text || a.type === exports2.NodeType.CDATA)
        return a.textContent === b.textContent;
      else if (a.type === exports2.NodeType.Element)
      ...
      switch (n.nodeType) {
        case n.DOCUMENT_NODE:
          if (n.compatMode !== "CSS1Compat") {
            return {
              type: exports2.NodeType.Document,
              childNodes: [],
        ...
        case n.DOCUMENT_TYPE_NODE:
          return {
            type: exports2.NodeType.DocumentType,
            name: n.name,
            publicId: n.publicId,
            systemId: n.systemId,
            rootId
        ...
        case n.CDATA_SECTION_NODE:
          return {
            type: exports2.NodeType.CDATA,
            textContent: "",
            rootId
          };
        case n.COMMENT_NODE:
          return {
            type: exports2.NodeType.Comment,
    ...
    function serializeElementNode(n, options) {
      ...
      return {
        type: exports2.NodeType.Element,
        tagName,
        attributes,
        childNodes: [],
    ...
    function slimDOMExcluded(sn, slimDOMOptions) {
      if (slimDOMOptions.comment && sn.type === exports2.NodeType.Comment) {
        return true;
      } else if (sn.type === exports2.NodeType.Element) {
    ...
    function serializeNodeWithId(n, options) {
      ...
      if (mirror.hasNode(n)) {
        id = mirror.getId(n);
      } else if (slimDOMExcluded(_serializedNode, slimDOMOptions) || !preserveWhiteSpace && _serializedNode.type === exports2.NodeType.Text && !_serializedNode.isStyle && !_serializedNode.textContent.replace(/^\s+|\s+$/gm, "").length) {
        id = IGNORED_NODE;
      } else {
        id = genId();
      }
      ...
      if (serializedNode.type === exports2.NodeType.Element) {
      ...
      if ((serializedNode.type === exports2.NodeType.Document || serializedNode.type === exports2.NodeType.Element) && recordChild) {
        if (slimDOMOptions.headWhitespace && serializedNode.type === exports2.NodeType.Element && serializedNode.tagName === "head") {
        ...
        if (serializedNode.type === exports2.NodeType.Element && serializedNode.tagName === "textarea" && serializedNode.attributes.value !== void 0) ;
        else {
      ...
      if (serializedNode.type === exports2.NodeType.Element && serializedNode.tagName === "iframe") {
        onceIframeLoaded(n, () => {
      ...
      if (serializedNode.type === exports2.NodeType.Element && serializedNode.tagName === "link" && typeof serializedNode.attributes.rel === "string" && (serializedNode.attributes.rel === "stylesheet" || serializedNode.attributes.rel === "preload" && typeof serializedNode.attributes.href === "string" && extractFileExtension(serializedNode.attributes.href) === "css")) {
    ...
    function visitSnapshot(node, onVisit) {
      function walk(current) {
        onVisit(current);
        if (current.type === exports2.NodeType.Document || current.type === exports2.NodeType.Element) {
    ...
    function buildNode(n, options) {
      ...
      switch (n.type) {
        case exports2.NodeType.Document:
          return doc.implementation.createDocument(null, "", null);
        case exports2.NodeType.DocumentType:
          return doc.implementation.createDocumentType(n.name || "html", n.publicId, n.systemId);
        case exports2.NodeType.Element: {
    ...
    function buildNodeWithSN(n, options) {
      ...
      if (n.type === exports2.NodeType.Document) {
        doc.close();
        doc.open();
        if (n.compatMode === "BackCompat" && n.childNodes && n.childNodes[0].type !== exports2.NodeType.DocumentType) {
          if (n.childNodes[0].type === exports2.NodeType.Element && "xmlns" in n.childNodes[0].attributes && n.childNodes[0].attributes.xmlns === "http://www.w3.org/1999/xhtml") {
      ...
      mirror.add(node, n);
      if ((n.type === exports2.NodeType.Document || n.type === exports2.NodeType.Element) && !skipChild) {
        for (const childN of n.childNodes) {
          ...
          } else if (n.type === exports2.NodeType.Document && childN.type == exports2.NodeType.Element) {
    ...
    function handleScroll(node, mirror) {
      ...
      if ((n === null || n === void 0 ? void 0 : n.type) !== exports2.NodeType.Element) {
        return;
      }
      const el = node;
      for (const name in n.attributes) {
    ...
    exports2.adaptCssForReplay = adaptCssForReplay;
    exports2.buildNodeWithSN = buildNodeWithSN;
...
// src/snapshot.ts
var import_rrweb_snapshot = __toESM(require_rrweb_snapshot(), 1);
var pixeleyeSnapshot = (options) => {
